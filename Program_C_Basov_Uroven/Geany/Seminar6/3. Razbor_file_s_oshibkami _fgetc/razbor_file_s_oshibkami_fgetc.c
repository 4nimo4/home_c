/*
        Разбор файла с ошибками с помощью fgets
//------------------------------------------------------
        Файл с ошибками
//------------------------------------------------------
2021;01;16
...
//------------------------------------------------------
        Разбор файла с ошибками с помощью fgets
это необходимо , если строка длинная- если мы 20 байт заложили, а строка длиннее
//------------------------------------------------------
*/
...
char ch=0;
                                            ...
                                            //каждый раз должно три параметра считываться
    {
        ...
        {
            do  //прямо в цикле do while считывать символы функцией fgetc 
            {
                putchar(ch);
                ch=fgetc(open);
            } while(EOF!=ch && '\n'!=ch); //пока не встретится конец файла, либо переход на новую строку
